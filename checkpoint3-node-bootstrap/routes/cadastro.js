...
import { cadastraUsuario, statusDoUsuario, dataDoCadastro } from '../functions/User.js';


const router = express.Router();
function VerifyErroCode() {
    switch (errorCode) {
...
router.post('/cadastro', (req, res, next) => {
    const dados = {
        ...
        DataDeCadastramento: dataDoCadastro()
    }
    cadastraUsuario(req.body.email, req.body.senha, dados).then((userCredential) => {
        res.redirect('/perfil');
    })
});
